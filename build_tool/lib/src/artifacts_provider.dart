...
class Artifact {
  ...
  ArtifactType get type {
    if (finalFileName.endsWith('.dll') ||
      ...
      throw ArtifactException('Unknown artifact type for "$finalFileName".');
    }
  }
...
class ArtifactMaterializer {
  ...
  static List<String> copyDynamicLibraries(
    ...
    final copied = <String>[];
    for (final lib in artifactsForType(artifacts, type: ArtifactType.dylib)) {
...
enum ArtifactType { staticlib, dylib }
